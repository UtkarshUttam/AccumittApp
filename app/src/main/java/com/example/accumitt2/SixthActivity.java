...
public class SixthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectButton = findViewById(R.id.button63);
        startButton = findViewById(R.id.button61);
        stopButton = findViewById(R.id.button62);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isConnected) {
                    ...
                    Toast.makeText(SixthActivity.this, "Please connect to HC-05 first", Toast.LENGTH_SHORT).show();
                }
            }
        });
