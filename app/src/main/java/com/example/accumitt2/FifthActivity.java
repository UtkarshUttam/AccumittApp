...
public class FifthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectButton = findViewById(R.id.button53);
        startButton = findViewById(R.id.button51);
        stopButton = findViewById(R.id.button52);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isConnected) {
                    ...
                    Toast.makeText(FifthActivity.this, "Please connect to HC-05 first", Toast.LENGTH_SHORT).show();
                }
            }
        });
