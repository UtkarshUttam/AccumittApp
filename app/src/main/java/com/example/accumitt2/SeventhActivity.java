...
public class SeventhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectButton = findViewById(R.id.button73);
        startButton = findViewById(R.id.button71);
        stopButton = findViewById(R.id.button72);
        ...
        startButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isConnected) {
                    ...
                    Toast.makeText(SeventhActivity.this, "Please connect to HC-05 first", Toast.LENGTH_SHORT).show();
                }
            }
        });
